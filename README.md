...
- `python3 scripts/check_mlx_runtime.py --python .cache/angella/bootstrap-venv/bin/python`: bootstrap venv의 MLX import를 안전하게 진단하는 probe.
- `python3 scripts/start_mlx_server.py --dry-run`: canonical MLX env에서 `mlx_lm.server` 실행 명령을 구성하는 launcher.
