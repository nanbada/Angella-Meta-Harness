...
- `.cache/angella/control-plane/wiki-index.sqlite`
- `.cache/angella/control-plane/knowledge-sync.json`
- `.cache/angella/control-plane/install/summary.json`
- `.cache/angella/control-plane/install/telemetry.jsonl`

Tracked harness wiki:
...
- `knowledge/queries/*.md`
- `PARITY.md`
- `config/knowledge-policy.yaml`
...
- tracked `knowledge/index.md`, `knowledge/log.md`, `knowledge/components/*.md` 와 builtin wiki index를 sync
- tracked `knowledge/sources/*.md` 와 `knowledge/queries/*.md` 를 sync
...
- tracked harness wiki를 builtin search로 질의
...
- verification-only run도 tracked component/index/log sync를 수행하지만 draft promotion/export는 수행하지 않습니다
- summary/report/search snippet에는 heuristic compaction telemetry가 기록될 수 있습니다
...
personal-agent non-goal은 [`docs/personal-agent-non-goals.md`](/Users/nanbada/projects/Angella/docs/personal-agent-non-goals.md) 에 정리한다.

Harness knowledge/public tool surface:
...
- `PARITY.md` + `scripts/run_harness_parity_diff.py`
