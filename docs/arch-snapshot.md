...
- **scion-coordination**: Google Scion 개념을 참조하는 file-backed coordination MVP입니다. active peer 상태, file claim, heartbeat, broadcast event를 shared dir에 기록해 충돌을 줄입니다.
